...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "AppSettings",                dependencies: ["Analytics"],                                            path:"AppSettings/Sources"),
        .target(name: "Assistant",                  dependencies: ["Dragoman", "TTS", "STT", "TextTranslator", "Analytics"],path:"Assistant/Sources"),
        .target(name: "AudioSwitchboard",           dependencies: ["Analytics"],                                            path:"AudioSwitchboard/Sources"),
        ...
        .target(name: "Meals",                      dependencies: ["AutomatedFetcher", "SwiftSoup", "Analytics"],           path:"Meals/Sources"),
        .target(name: "PublicCalendar",             dependencies: ["AutomatedFetcher", "SwiftSoup", "Analytics"],           path:"PublicCalendar/Sources"),
        ...
        .target(name: "STT",                        dependencies: ["AudioSwitchboard", "FFTPublisher", "Analytics"],        path:"STT/Sources"),
